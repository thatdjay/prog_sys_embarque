...
#define RS          PORTBbits.RB4 // PORTDbits.RD2
#define RW          PORTAbits.RA5 // PORTDbits.RD1
#define EN          PORTAbits.RA4 //PORTDbits.RD3
#define MODE_IN     TRISA = 0b00001111
#define MODE_OUT    TRISA = 0b00000000
...
#define LIGNE1_START        0x00            // Adresses de début des lignes
#define LIGNE2_START        0x40
#define LIGNE3_START        0x14
#define LIGNE4_START        0x54
...
char matCGRAM[8][8] =
{
    ...
    {2,4,0x0E,0x11,0x1F,0x10,0x0E,0},        // é
    {2,4,0x1F,0x10,0x1E,0x10,0x1F,0},        // É
    {8,4,0x0E,0x11,0x1F,0x10,0x0E,0},        // è
